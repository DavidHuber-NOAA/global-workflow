...
class GFSTasks(Tasks):
    ...
    def _wavepostbndpnt(self, name_in):
        ...
        history_path = self._template_to_rocoto_cycstring(self._base['COM_WAVE_HISTORY_TMPL'])
        history_file = f'{self.run}.wave.t@Hz.points.f{fhmax_wav_ibp:03d}.log'
    ...
    def arch_tars(self):
        ...
        if self._configs['arch_tars'].get('ARCH_GAUSSIAN', 'YES') == 'YES':
            tarball_types.extend(['gfs_flux', 'gfs_netcdfb_grp1', 'gfs_netcdfb_grp2', 'gfs_netcdfb_grp3', 'gfs_netcdfb_grp4', 'gfs_pgrb2b'])
